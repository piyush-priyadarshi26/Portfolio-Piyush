...
export const metadata: Metadata = {
  title: "Piyush Kumar Priyadarshi — Portfolio",
  description: "Web Dev Learner passionate about Tech & Startups. Exploring projects, GenAI, and building meaningful things.",
};
